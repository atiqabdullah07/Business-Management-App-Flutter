...
import '../../WebHandler/Settings/dashboard_settings_controller.dart';

class DashboardSettingsTable extends StatelessWidget {
  final DashboardSettingsController dashboardSettingsController = Get.find();
                        ...
                        child: SizedBox(
                          ...
                          child: SwitchButton(
                            ...
                            onPress: () async {
                              ...
                              await dashboardSettingsController
                                  .changeSettingStatus(
                                      settingsID: tableRowsLit[index]
                                          .settingID
                                          .toString(),
                                      departmentID: DashBoardFunction.id);
