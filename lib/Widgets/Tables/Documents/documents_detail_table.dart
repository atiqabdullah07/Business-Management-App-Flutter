...
class DocumentsDetailTable extends StatelessWidget {
  const DocumentsDetailTable({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        //                 ),
        //                 child: AppText(
        //                   title: '${tableRowsLit[index]['CATEGORY']}',
        //                   color: AppColors.secondary,
        //                   size: 8,
        //                   fontWeight: FontWeight.w500,
        //                 ),
        ...
        //                     ),
        //                     child: AppText(
        //                       title: '${tableRowsLit[index]['ACTION']}',
        //                       color: AppColors.tertiary,
        //                       size: 8,
        //                       fontWeight: FontWeight.w500,
